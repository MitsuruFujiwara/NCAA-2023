...
feats_path = '../feats/f103_*.feather'

sub_path = '../output/submission_lgbm_mens_simple.csv'
oof_path = '../output/oof_lgbm_mens_simple.csv'

model_path = '../models/lgbm_mens_simple_'

imp_path_png = '../imp/lgbm_importances_mens_simple.png'
imp_path_csv = '../imp/feature_importance_lgbm_mens_simple.csv'
