...
from utils import WBASE_DIR, DICT_LOC

#==============================================================================
# preprocess season results womens
#==============================================================================

def main():

    # load csv
    RegularSeasonDetailedResults = pd.read_csv(f'{WBASE_DIR}/WRegularSeasonDetailedResults.csv')
